# Hướng Dẫn Setup Database Neon

Bạn đã deploy thành công lên Vercel! Bây giờ chỉ cần setup database là xong.

## Cách 1: Sử dụng Prisma CLI (Đơn giản nhất - Khuyến nghị)
...
## Cách 2: Chạy SQL trực tiếp trong Neon (Nếu Cách 1 gặp lỗi)

### Bước 1: Mở Neon SQL Editor

1. Vào https://console.neon.tech
2. Chọn database `VoCucPHuong_Database`
3. Click tab **SQL Editor**

### Bước 2: Copy và paste đoạn SQL sau:
...
Sau khi setup xong, truy cập website của bạn:

🌐 **https://cong-ty-tnhh-vo-cuc-phuong-public.vercel.app**

Website sẽ hoạt động đầy đủ với:
...
### Nếu gặp lỗi "relation already exists"

Database đã được tạo rồi, bạn có thể bỏ qua và test website ngay!

### Nếu gặp lỗi khi chạy `prisma db push`

Sử dụng Cách 2 để chạy SQL trực tiếp trong Neon.
...
Hoặc vào Neon Console → Tables để xem các bảng đã tạo.
